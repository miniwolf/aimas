...
node.addChild(op1);
  ...
  final public void problem() throws ParseException {Exp node = null;
        Symbol name = null;
    try {
      left_bracket();
      jj_consume_token(DEFINE);
...
node.addChild(op1);
  ...
  final public void goal() throws ParseException {Exp node = null;
...
this.error(e, token.beginLine, token.beginColumn);
  ...
  final public void constraints(int type) throws ParseException {Exp conGD = null;
    try {
      jj_consume_token(LEFT_BRACKET);
      jj_consume_token(CONSTRAINTS);
      conGD = pref_con_gd();
