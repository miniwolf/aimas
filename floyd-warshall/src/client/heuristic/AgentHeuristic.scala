...
/**
  ...
  */
class AgentHeuristic(boxToRemove: Box, boxPath: List[Position], dangerZone: HashSet[Position],
  ...
  override def h(n: Node): Int = {
    ...
    PathFinding.findPath2(n, matchingBox, n.getAgent.getPosition, edges).length + numberOfIssues
  }
}
