...
public class Node {
    ...
    private int g;
    private List<Agent> agents = new ArrayList<Agent>(); // SJW
    ...
    public ArrayList<Node> getExpandedNodes() {
        ...
        // TODO: Splitta commands on 2 agents og later all
    	...
    	for(int i = 0; i < agents.size(); i++) {
	        for ( Command c : Command.every ) {    
	            ...
	            if ( c.actType == type.Move ) {
	                ...
	                if(i == 0) n.getAgents().get(0).setPosition(agentPos);
	                else if(i == 1) n.getAgents().get(1).setPosition(agentPos);
